...
use App\Http\Requests\RoadRequest as StoreRequest;
use App\Http\Requests\RoadRequest as UpdateRequest;
...
class RoadCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Road');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/road');
        $this->crud->setEntityNameStrings('road', 'roads');
        ...
        */
        ...
        $this->crud->addField([  // Select2
           'label' => "Category",
           'type' => 'select2',
           'name' => 'road_category_id', // the db column for the foreign key
           'entity' => 'roadCategory', // the method that defines the relationship in your Model
           'attribute' => 'name', // foreign key attribute that is shown to user
           'model' => "App\Models\RoadCategory" // foreign key model
        ]);
        $this->crud->addField([  // Select2
           'label' => "Organization",
           'type' => 'select2',
        ...
        $this->crud->addField([ // select_from_array
            ...
            'options' => ['started' => 'Started','not-started' => 'Not Started' ,'finished' => 'Finished'],
            'allows_null' => false,
        ...
        $this->crud->addColumn([
           ...
           'type' => "select",
           'name' => 'road_category_id', // the column that contains the ID of that connected entity;
           'entity' => 'roadCategory', // the method that defines the relationship in your Model
           'attribute' => "name", // foreign key attribute that is shown to user
           'model' => "App\Models\RoadCategory", // foreign key model
        ]);
